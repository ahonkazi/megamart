...
const Testimonial = () => {
    ...
    return (
        <section className="bg-gray-50 swiperPerViewAuto">
            <div className="mx-auto max-w-[1340px] px-4 sm:px-6 lg:me-0 py-section">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
                    <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                        <h2 className="text-3xl font-Secondary font-bold tracking-tight text-gray-900 sm:text-4xl">
        ...
        <div className="keen-slider__slide w-full">
            ...
            >
                <div>
                    ...
                    <div className="mt-4">
                        <p className="text-2xl font-bold text-Primary sm:text-3xl">Stayin' Alive</p>
